...
void BirdItem::updatePixmap(){
   if(wingPosition == WingPosition::Middle){
       if(wingDirection){
           //up
           setPixmap(QPixmap("C:\\Users\\PC\\Desktop\\images\\bird-up.png"));
           wingPosition = WingPosition::Up;
           wingDirection = 0;
       }else{
           //down
           setPixmap(QPixmap("C:\\Users\\PC\\Desktop\\images\\bird-down.png"));
           wingPosition = WingPosition::Down;
           wingDirection = 1;
       }
   }else{
       setPixmap(QPixmap("C:\\Users\\PC\\Desktop\\images\\bird-middle.png"));
